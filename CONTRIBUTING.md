Contributing to Brewhaust
============================

The Brewhaust project operates an open contributor model where anyone is
...
The following applies to code changes to the Brewhaust project, and is not to be
confused with overall BREWHAUST Network Protocol consensus changes.

Whether a pull request is merged into Brewhaust rests with the project merge
...
Patches that change BREWHAUST consensus rules are considerably more involved than
...
Where a patch set proposes to change the BREWHAUST consensus, it must have been
...
The project leader is the release manager for each Brewhaust release.
