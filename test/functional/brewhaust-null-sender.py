...
from test_framework.brewhaustconfig import *

class BrewhaustNullSenderTest(BrewhaustTestFramework):
    ...
    def run_test(self):
        ...
        tx.vout = [CTxOut(0, CScript([b"\x04", CScriptNum(1000000), CScriptNum(BREWHAUST_MIN_GAS_PRICE), b"\x00", OP_CREATE]))]
