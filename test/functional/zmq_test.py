...
from test_framework.test_framework import BrewhaustTestFramework, SkipTest
...
class ZMQTest (BrewhaustTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that brewhaust has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("brewhaustd has not been built with zmq enabled.")
