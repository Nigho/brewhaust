...
#include "genesis/brewhaustMainNetwork.cpp"
#include "genesis/brewhaustTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::brewhaustMainNetwork: return c_genesisInfoBrewhaustMainNetwork;
	case Network::brewhaustTestNetwork: return c_genesisInfoBrewhaustTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::brewhaustMainNetwork: return c_genesisStateRootBrewhaustMainNetwork;
	case Network::brewhaustTestNetwork: return c_genesisStateRootBrewhaustTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
