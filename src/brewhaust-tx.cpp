...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Brewhaust brewhaust-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  brewhaust-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded brewhaust transaction") + "\n" +
                               "  brewhaust-tx [options] -create [commands]   " + _("Create hex-encoded brewhaust transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded brewhaust transaction
