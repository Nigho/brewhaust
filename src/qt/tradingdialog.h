...
#ifndef BREWHAUST_TRADINGDIALOG_H
#define BREWHAUST_TRADINGDIALOG_H
...
private slots:
    ...
    void showBalanceOfBREWHAUSTOnTradingTab();
    ...
    void showBalanceOfBREWHAUSTOnSendTab();
    void showBalanceOfBREWHAUSTOnBalanceTab();
    ...
    QString BuyBREWHAUST(QString OrderType, double Quantity, double Rate);
    QString SellBREWHAUST(QString OrderType, double Quantity, double Rate);
    ...
    QString sendRequest(QString url, QString method = "GET", QString body = QString("{\"market\":\"BREWHAUST/BTC\"}"));// "{\"gender\":\"male\"}");
    void sendRequest1(QString url, std::function<void (void)> funcForCallAfterReceiveResponse, QString method = "GET", QString body = QString("{\"market\":\"BREWHAUST/BTC\"}"));// "{\"gender\":\"male\"}");
...
#endif //BREWHAUST_TRADINGDIALOG_H
