...
/** Utility functions used by the BREWHAUST Qt UI.
 */
namespace GUIUtil
{
...
// Render BREWHAUST addresses in monospace font
...
// Parse "brewhaust:" URI into recipient object, return true on successful parsing
