// Copyright (c) 2015-2018 The BREWHAUST developers
...
void Eula::showDialog()
{
    ...
    QString currentVersion = tr("brewhaust_") + QString::fromStdString(strprintf("%d%d%d%d",
    ...
    if (settings.contains(tr("brewhaustVersion")))
    {
        QString storeVersion = settings.value(tr("brewhaustVersion")).toString();
        ...
        else
        {
            ...
            settings.setValue(tr("brewhaustVersion"), currentVersion);
        }
    }
    else
    {
