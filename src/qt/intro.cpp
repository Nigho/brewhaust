...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Brewhaustcore"),
     ...
     * override -datadir in the brewhaust.conf file in the default data directory
     * (to be consistent with brewhaustd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
