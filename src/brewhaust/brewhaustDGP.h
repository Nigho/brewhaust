#ifndef BREWHAUSTDGP_H
#define BREWHAUSTDGP_H
...
public:
    ...
    BrewhaustDGP(BrewhaustState* _state, bool _dgpevm = true) : dgpevm(_dgpevm), state(_state) { initDataEIP158(); }
