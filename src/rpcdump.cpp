...
UniValue importprivkey(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "importprivkey \"brewhaustprivkey\" ( \"label\" rescan )\n"
    ...
    if (fRescan) {
        ...
        if (pwalletMain->IsAbortingRescan()) {
            msg =  _("Rescan aborted by user. Please restart your Brewhaust wallet with '-rescan' option. Otherwise, transaction data");
        ...
        {
            msg =  _("'importprivkey' with 'Rescan' option finished successfully. Please restart your Brewhaust wallet. Otherwise, transaction data");
            msg += _(" or address book entries might be missing or incorrect");
        }
    }
    else
    {
        msg =  _("'importprivkey' finished successfully. Please restart Brewhaust wallet with '-rescan' option. Otherwise, transaction data");
        msg += _(" or address book entries might be missing or incorrect");
    }
...
UniValue importaddress(const UniValue& params, bool fHelp)
{
    ...
    if (IsValidDestination(dest)) {
        ...
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid BREWHAUST address or script");
    }
...
UniValue dumpwallet(const UniValue& params, bool fHelp)
{
    ...
    // produce output
    file << strprintf("# Wallet dump created by BREWHAUST %s (%s)\n", CLIENT_BUILD, CLIENT_DATE);
