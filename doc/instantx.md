...
This mechanism has been integrated into Bitcore-Node-BREWHAUST which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BREWHAUST-Project/insight-api-brewhaust#web-socket-api](https://github.com/BREWHAUST-Project/insight-api-brewhaust#web-socket-api) 
* API: [https://github.com/BREWHAUST-Project/insight-api-brewhaust#instantx-transactions](https://github.com/BREWHAUST-Project/insight-api-brewhaust#instantx-transactions)
...
By default, the Brewhaust daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Brewhaust daemon:
